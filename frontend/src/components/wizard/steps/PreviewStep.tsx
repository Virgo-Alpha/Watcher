  ...
  return (
    <div className="preview-step">
      ...
      <p className="step-description">
        Here's the monitoring configuration generated by AI. If this looks correct, click "Create Haunt" to start monitoring.
      </p>
        ...
        <div className="preview-section">
          ...
          <details className="config-details">
            ...
            <div className="config-content">
              ...
              {config.normalization && typeof config.normalization === 'object' && Object.keys(config.normalization).length > 0 && (
                <div className="config-subsection">
                  <h5>Normalization Rules</h5>
                  <pre>{JSON.stringify(config.normalization, null, 2)}</pre>
                </div>
              )}
              {config.truthy_values && typeof config.truthy_values === 'object' && Object.keys(config.truthy_values).length > 0 && (
                <div className="config-subsection">
                  <h5>Truthy Values</h5>
